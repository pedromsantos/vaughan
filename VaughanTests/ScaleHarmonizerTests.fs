...
module ScalesHormonizerTests =
    ...
    let ``Should create triads for Ionian scale`` () =
        ...
        (triadsHarmonizer ScaleDegree.II cIonian).Notes
        |> should equal dMin.Notes
        (triadsHarmonizer ScaleDegree.III cIonian).Notes
        |> should equal eMin.Notes
        (triadsHarmonizer ScaleDegree.IV cIonian).Notes
        |> should equal fMaj.Notes
        (triadsHarmonizer ScaleDegree.V cIonian).Notes
        |> should equal gMaj.Notes
        (triadsHarmonizer ScaleDegree.VI cIonian).Notes
        |> should equal aMin.Notes
        (triadsHarmonizer ScaleDegree.VII cIonian).Notes
    ...
    let ``Should create seventh chords for Ionian scale`` () =
        ...
        (seventhsHarmonizer ScaleDegree.II cIonian).Notes
        |> should equal dMin7.Notes
        (seventhsHarmonizer ScaleDegree.III cIonian).Notes
        |> should equal eMin7.Notes
        (seventhsHarmonizer ScaleDegree.IV cIonian).Notes
        |> should equal fMaj7.Notes
        (seventhsHarmonizer ScaleDegree.V cIonian).Notes
        |> should equal gDom7.Notes
        (seventhsHarmonizer ScaleDegree.VI cIonian).Notes
        |> should equal aMin7.Notes
        (seventhsHarmonizer ScaleDegree.VII cIonian).Notes
    ...
    let ``Should create seventh chords for Harmonic Minor scale`` () =
        ...
        (seventhsHarmonizer ScaleDegree.II cMinor).Notes
        |> should equal dMin7b5.Notes
        (seventhsHarmonizer ScaleDegree.III cMinor).Notes
        |> should equal eFlatAug7.Notes
        (seventhsHarmonizer ScaleDegree.IV cMinor).Notes
        |> should equal fMin7.Notes
        (seventhsHarmonizer ScaleDegree.V cMinor).Notes
        |> should equal gDom7.Notes
        (seventhsHarmonizer ScaleDegree.VI cMinor).Notes
        |> should equal aFlatMaj7.Notes
        (seventhsHarmonizer ScaleDegree.VII cMinor).Notes
    ...
    let ``Should create ninth chords for Ionian scale`` () =
        ...
        (ninthsHarmonizer ScaleDegree.II cIonian).Notes
        |> should equal dMin9.Notes
        (ninthsHarmonizer ScaleDegree.III cIonian).Notes
        |> should equal eMin9.Notes
        (ninthsHarmonizer ScaleDegree.IV cIonian).Notes
        |> should equal fMaj9.Notes
        (ninthsHarmonizer ScaleDegree.V cIonian).Notes
        |> should equal gDom9.Notes
        (ninthsHarmonizer ScaleDegree.VI cIonian).Notes
        |> should equal aMin9.Notes
        (ninthsHarmonizer ScaleDegree.VII cIonian).Notes
        |> should equal bMin9b5.Notes
