namespace VaughanTests
    ...
    module ImprovisationGuitarTests =
        ...
        let ``Should render tab for C Dominant 7 scale up to seventh in chords`` () =
            ...
            |> should equal (
                             "e||-----------------------------------------------------------------------------------------||" + Environment.NewLine +
                             "B||----------------------------------------------------------------------5--8--------6--10--||" + Environment.NewLine +
                             "G||------------------------------------7--------5--9--------7--10-----5-----------7---------||" + Environment.NewLine +
                             "D||--------5--8--------7--10-----5--8--------7--------5--8---------7-----------8------------||" + Environment.NewLine +
                             "A||-----7--------5--8---------7-----------8-------------------------------------------------||" + Environment.NewLine +
                             "E||--8--------------------------------------------------------------------------------------||" + Environment.NewLine)
        ...
        let ``Should render tab for C Dominant 7 scale down to seventh in chords`` () =
            ...
            |> should equal (
                             "e||-----------------------------------------------------------------------------------------||" + Environment.NewLine +
                             "B||--10--6--------8--5----------------------------------------------------------------------||" + Environment.NewLine +
                             "G||---------7-----------5-----10--7--------9--5--------7------------------------------------||" + Environment.NewLine +
                             "D||------------8-----------7---------8--5--------7--------8--5-----10--7--------8--5--------||" + Environment.NewLine +
                             "A||-------------------------------------------------8-----------7---------8--5--------7-----||" + Environment.NewLine +
                             "E||--------------------------------------------------------------------------------------8--||" + Environment.NewLine)